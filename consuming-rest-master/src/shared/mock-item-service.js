class ItemService {
  ...
  constructor() {
    this.items = [
      ...
      {link:4, name:"test4", summary:"Summary Test 4", year:"2004", country:"cz", price:"3000", description:"Desc 3"},
      {link:5, name:"test5", summary:"Summary Test 5", year:"2005", country:"cz", price:"3000", description:"Desc 3"},
    ];
  }
